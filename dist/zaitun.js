(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Zaitun = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
const patch = snabbdom.init([require('snabbdom/modules/class'), // makes it easy to toggle classes
...
},{"./router":13,"snabbdom":11,"snabbdom/h":4,"snabbdom/modules/class":7,"snabbdom/modules/eventlisteners":8,"snabbdom/modules/props":9,"snabbdom/modules/style":10}],2:[function(require,module,exports){
...
},{"./core":1,"./router":13,"snabbdom-jsx":3,"snabbdom/h":4}],3:[function(require,module,exports){
"use strict";
...
},{"./htmldomapi":5,"./is":6,"./vnode":12}],12:[function(require,module,exports){
    ...
    listen: function () {
        ...
        Array.from(document.querySelectorAll('a')).forEach(it => {
            it.addEventListener('click', ev => {
                ev.preventDefault();
                if (this.clearSlashes(ev.target.href) === this.clearSlashes(window.location.href)) {
                    return;
                }
