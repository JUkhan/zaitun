                ...
                switch (elm.type) {
                   ...
                   case 'component': 
                        velms.push(h(`div.col-md-${elm.size||6}`,[elm.component.view({
                            ...
                            handler:a=>this.handler({type:elm.actionType, action:a})
                        })]));
                        break; 
                  case 'vnode': 
        ...
        switch (item.type) {
            ...
            case 'component':            
                 vnodes.push(item.component.view({
                     ...
                     handler:a=>this.handler({type:item.actionType, action:a})
                 }));
...
export default {juForm, TAB_CLICK}
